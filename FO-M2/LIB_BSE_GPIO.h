...
//-----------------------------------------------------------------------------
// El?ments présents sur la carte 8051FO20
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//  Pulse_P20
//	Génération d'une impulsion de 500ns sur P2.0
//----------------------------------------------------------------------------
void Pulse_P20(void);
//-----------------------------------------------------------------------------
//  Pulse_P21
//	Génération d'une impulsion de 500ns sur P2.1
//----------------------------------------------------------------------------
void Pulse_P21(void);
//-----------------------------------------------------------------------------
//  test_Pulse_P20
//	Génération d'une impulsion de 500ns sur P2.0
//----------------------------------------------------------------------------
void test_Pulse_P20(void);
//-----------------------------------------------------------------------------
//  test_Pulse_P21
//	Génération d'une impulsion de 500ns sur P2.1
//----------------------------------------------------------------------------
void test_Pulse_P21(void);